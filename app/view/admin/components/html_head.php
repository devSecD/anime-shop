<head>
    ...
    <link rel="stylesheet" href="/anime-shop/public/assets/css/components/sidebar.css">
    ...
    <?php endif; ?>
    <?php if($page === 'order_detail'): ?>
        <link rel="stylesheet" href="/anime-shop/public/assets/css/components/order-detail.css">
    <?php endif; ?>
    <?php if($page === 'updateConfiguration'): ?>
        <link rel="stylesheet" href="/anime-shop/public/assets/css/components/update-configuration.css">
    <?php endif; ?>
